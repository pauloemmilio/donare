...
urlpatterns = [
 ...
 url(r'^ong/despesas/(?P<ong_id>[0-9]+)/edit/(?P<despesas_id>[0-9]+)', login_required(views.alterar_despesas), name='alterar_despesas'),
 url(r'^ong/despesas/(?P<ong_id>[0-9]+)/delete(?P<despesas_id>[0-9]+)/', login_required(views.deletar_despesas), name='deletar_despesas'),
